...
`psk_ota` is the ESP-IDF OTA example for Protonest Connect devices using PSK username/password authentication.
...
2. Use the generated binary from `build/protonest_psk_ota.bin`.
...
```text
Protonest Connect ESP-IDF PSK OTA example
