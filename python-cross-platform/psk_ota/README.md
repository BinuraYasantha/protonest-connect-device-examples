...
`psk_ota` is the cross-platform Python OTA example for Protonest Connect devices using PSK username/password authentication.
...
```text
Protonest Connect Python cross-platform PSK OTA example
...
PSK default OTA worker version 0.0.1 started
...
PSK normal OTA test worker version 1.1.0 started
Application marked healthy
