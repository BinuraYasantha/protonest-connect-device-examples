...
def main():
    ...
    print("Protonest Connect Python cross-platform PSK publish example")
    ...
    while True:
        ...
        try:
            ...
            if ever_connected.is_set():
                print("PSK publish example error after connection loss:", exc)
            else:
                print("PSK publish example error during initial connect:", exc)
