...
def main():
    ...
    print("Protonest Connect Python cross-platform X.509 connect example")
    ...
    while True:
        ...
        try:
            ...
            if ever_connected.is_set():
                print("X.509 connect example error after connection loss:", exc)
            else:
                print("X.509 connect example error during initial connect:", exc)
