...
`ota` is the Pico W MicroPython OTA example for Protonest Connect devices using PSK username/password authentication.
...
```text
Protonest Connect Pico W MicroPython OTA example
...
Syncing time...
Time synced: (2026, 6, 25, 3, 50, 10, 3, 176)
